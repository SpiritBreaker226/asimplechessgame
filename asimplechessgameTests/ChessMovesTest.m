...
-(void)testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoard_shouldReturnSameLocation {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 3;
	
	[_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a Empty
	XCTAssertEqual(1, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Row 1");
	XCTAssertEqual(3, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Column 3");
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Right: Cell Type is Black Pawn");
}// end of testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoard_shouldReturnSameLocation()

-(void)testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoardWithWhitePawnInTopRight_shouldRetunLocationOfWhitePawn {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 1;
	
	[_testChessBoard moveCellStateFromRow:6 andColumn:3 toRow:2 andColumn:2];
	
	XCTAssertEqual(7, [[_testChessBoard getCurrentStateAtRow:2 andColumn:2] chessPieceType], @"Chess Moves Is The Cell Empty For Top Right: There is White Pawn Top Right");
	
	[_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a black pawn
	XCTAssertEqual(2, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Row 2");
	XCTAssertEqual(2, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Column 2");
	XCTAssertEqual(7, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Right: Cell Type is White Pawn");
}// end of testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoardWithWhitePawnInTopRight_shouldRetunLocationOfWhitePawnAndYes()

-(void)testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoardWithBlackPawnInTopRight_shouldRetunSameLocation {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 3;
	
	[_testChessBoard moveCellStateFromRow:1 andColumn:4 toRow:2 andColumn:4];
	
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:2 andColumn:4] chessPieceType], @"Chess Moves Is The Cell Empty For Top Right: There is a Black Pawn Top Right");
	
	[_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a White pawn
	XCTAssertEqual(2, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Row 2");
	XCTAssertEqual(4, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Right: Location of Destionation On Cell Column 4");
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Right: Cell Type is Black Pawn");
}// end of testCheckCellIsEmptyForTopRight_withVaildCoordsOnVaildBoardWithBlackPawnInTopRight_shouldRetunSameLocation()

-(void)testCheckCellIsEmptyForTopRight_withInVaildRowCoordsOnVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 7;
	NSInteger locationOfDestinationCol = 3;
	
	XCTAssertThrows([_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"], @"Chess Moves Check Cells To The Top Right Left: Error Invalid Row");
}// end of testCheckCellIsEmptyForTopRight_withInVaildRowCoordsOnVaildBoard_shouldErrorOut()

-(void)testCheckCellIsEmptyForTopRight_withInVaildColCoordsOnVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 3;
	NSInteger locationOfDestinationCol = 10;
	
	XCTAssertThrows([_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"], @"Chess Moves Check Cells To The Top Right Left: Error Invalid Column");
}// end of testCheckCellIsEmptyForTopRight_withInVaildColCoordsOnVaildBoard_shouldErrorOut()

-(void)testCheckCellIsEmptyForTopRight_withVaildCoordsOnInVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 4;
	NSInteger locationOfDestinationCol = 4;
	
	XCTAssertThrows([_testChessMoves checkIfTopRightCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:nil forCellType:@"Black"], @"Chess Moves Check Cells To The Top Right Left: Error not a valid board");
}// end of testCheckCellIsEmptyForTopRight_withInVaildCoordsOnVaildBoard_shouldErrorOut()
...
-(void)testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoard_shouldReturnSameLocation {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 3;
	
	[_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a Empty
	XCTAssertEqual(1, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Row 1");
	XCTAssertEqual(3, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Column 3");
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Left: Cell Type is Black Pawn");
}// end of testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoard_shouldReturnSameLocation()

-(void)testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoardWithWhitePawnInTopLeft_shouldRetunLocationOfWhitePawn {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 1;
	
	[_testChessBoard moveCellStateFromRow:6 andColumn:3 toRow:2 andColumn:0];
	
	XCTAssertEqual(7, [[_testChessBoard getCurrentStateAtRow:2 andColumn:0] chessPieceType], @"Chess Moves Is The Cell Empty For Top Left: There is White Pawn Top Left");
	
	[_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a black pawn
	XCTAssertEqual(2, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Row 2");
	XCTAssertEqual(0, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Column 0");
	XCTAssertEqual(7, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Left: Cell Type is White Pawn");
}// end of testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoardWithWhitePawnInTopLeft_shouldRetunLocationOfWhitePawnAndYes()

-(void)testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoardWithBlackPawnInTopLeft_shouldRetunSameLocation {
	NSInteger locationOfDestinationRow = 1;
	NSInteger locationOfDestinationCol = 3;
	
	[_testChessBoard moveCellStateFromRow:1 andColumn:4 toRow:2 andColumn:2];
	
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:2 andColumn:2] chessPieceType], @"Chess Moves Is The Cell Empty For Top Left: There is a Black Pawn Top Left");
	
	[_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"];
	
	// should be one point and on that point it should be a White pawn
	XCTAssertEqual(2, locationOfDestinationRow, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Row 2");
	XCTAssertEqual(2, locationOfDestinationCol, @"Chess Moves Is The Cell Empty For Top Left: Location of Destionation On Cell Column 2");
	XCTAssertEqual(1, [[_testChessBoard getCurrentStateAtRow:locationOfDestinationRow andColumn:locationOfDestinationCol] chessPieceType], @"Chess Moves Is The Cell Empty For Top Left: Cell Type is Black Pawn");
}// end of testCheckCellIsEmptyForTopLeft_withVaildCoordsOnVaildBoardWithBlackPawnInTopLeft_shouldRetunSameLocation()

-(void)testCheckCellIsEmptyForTopLeft_withInVaildRowCoordsOnVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 7;
	NSInteger locationOfDestinationCol = 3;
	
	XCTAssertThrows([_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"], @"Chess Moves Check Cells To The Top Left Left: Error Invalid Row");
}// end of testCheckCellIsEmptyForTopLeft_withInVaildRowCoordsOnVaildBoard_shouldErrorOut()

-(void)testCheckCellIsEmptyForTopLeft_withInVaildColCoordsOnVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 3;
	NSInteger locationOfDestinationCol = 10;
	
	XCTAssertThrows([_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:_testChessBoard forCellType:@"Black"], @"Chess Moves Check Cells To The Top Left Left: Error Invalid Column");
}// end of testCheckCellIsEmptyForTopLeft_withInVaildColCoordsOnVaildBoard_shouldErrorOut()

-(void)testCheckCellIsEmptyForTopLeft_withVaildCoordsOnInVaildBoard_shouldErrorOut {
	NSInteger locationOfDestinationRow = 4;
	NSInteger locationOfDestinationCol = 4;
	
	XCTAssertThrows([_testChessMoves checkIfTopLeftCellIsNotEmptyOnRow:&locationOfDestinationRow andColumn:&locationOfDestinationCol onBoard:nil forCellType:@"Black"], @"Chess Moves Check Cells To The Top Left Left: Error not a valid board");
}// end of testCheckCellIsEmptyForTopLeft_withInVaildCoordsOnVaildBoard_shouldErrorOut()
